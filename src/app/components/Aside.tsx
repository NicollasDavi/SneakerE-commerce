    ...
    <aside className='fixed left-0 h-screen w-2/12 p-5'>
      <div>
        ...
        <section className='flex flex-wrap gap-2'>
          ...
          <button onClick={() => handleColorClick('Pink')} className={`bg-pink-700 text-white rounded-full w-8 h-8 border ${selectedColor === 'Pink' ? 'border-black' : 'border-gray-300'} hover:bg-pink-900 transition duration-300 focus:outline-none focus:ring-2 focus:ring-gray-300`}></button>
      ...
      <div>
        ...
        <section className='flex flex-wrap gap-2'>
          ...
          <button onClick={() => handleCompanyClick('Purple')} className={`bg-white text-gray-800 rounded-full w-auto px-4 py-2 border ${selectedCompany === 'Purple' ? 'border-black' : 'border-gray-300'} hover:bg-gray-200 transition duration-300 focus:outline-none focus:ring-2 focus:ring-gray-300`}>Purple</button>
          {/* Adicione os botões restantes aqui */}
        </section>
      </div>
    </aside>
  );
